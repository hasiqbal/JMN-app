...
export const MISSED_UNITS_RKAAT_GUIDE: HowToGuide = {
  ...
  icon: 'history',
  color: '#00897B',
  intro: 'This guide explains how to complete missed units when you joined jamaah late (masbuq), including the case where you missed 3 and prayed 1 with the imam.',
  sections: [
    {
      ...
      steps: [
        ...
        { step: 3, title: 'Stand and complete what you missed', detail: 'After imam salam, stand and pray the units you missed.' },
    ...
    },
    {
      ...
      steps: [
        ...
        { step: 2, title: 'Imam ends, you stand', detail: 'When imam gives salam, stand up to complete your remaining 3 units.' },
        { step: 3, title: 'Pray your first make-up unit', detail: 'Pray one full unit.' },
        { step: 4, title: 'Sit now (important)', detail: 'After this one make-up unit, sit for tashahhud because total prayed is now 2 (1 with imam + 1 after imam).' },

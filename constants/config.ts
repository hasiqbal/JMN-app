...
export const APP_CONFIG = {
  ...
  radioStreams: [
    ...
    {
      id: 'sadaqat-ali',
      label: 'Qari Sadaqat Ali',
      sublabel: "Hafs 'an Asim",
      url: 'https://media.way2quran.com/sadaqat-ali/hafs-an-asim/{}',
      icon: 'menu-book',
      isRandom: false,
    },
    {
      id: 'ibrahim-kashidan',
      label: 'Qari Ibrahim Muhammad Kashidan',
      sublabel: "Hafs 'an Asim",
      url: 'https://media.way2quran.com/ibrahim-muhammad-kashidan/hafs-an-asim/{}',
      icon: 'menu-book',
      isRandom: false,
    },
    {
    ...
    {
      id: 'noreen-siddiq',
      label: 'Qari Noreen Muhammad Siddiq',
      sublabel: "Hafs 'an Asim",
      url: 'https://media.way2quran.com/noreen-muhammad-siddiq/hafs-an-asim/{}',
      icon: 'menu-book',
      isRandom: false,
    },
    {
      id: 'hadr',
      label: 'Full Quran Hadr',
      sublabel: 'Choose Juz 1-30 with auto-next',
      url: 'https://server8.mp3quran.net/afs/{SURAH_PADDED}.mp3',
      icon: 'library-music',
      isRandom: false,
    },
